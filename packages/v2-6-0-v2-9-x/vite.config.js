...
const base = process.env.NODE_ENV === "production" ? process.env.BASE_URL + "/v2-6-0-v2-9-x" : "";
          ...
          [`${base}/guide/`]: [
            ...
            },
            {
              ...
              items: [
                ...
                {
                  title: "mocha 測試報告",
                  to: `${process.env.VERSION_PAGE_BASE_URL}/mocha-report/v2-6-0-v2-9-x/mochawesome.html`
                }
              ]
            },
            {
